...
const Contact: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact - METROTECH INSTRUMENT SARL | Devis Métrologie Abidjan Côte d'Ivoire</title>
        <meta name="description" content="Contactez METROTECH INSTRUMENT SARL à Abidjan pour vos besoins en métrologie. Devis gratuit, étalonnage, vérification. Koumassi SOPIM, +225 05 46 86 85 71" />
        <meta name="keywords" content="contact METROTECH, devis métrologie, Abidjan, Koumassi SOPIM, téléphone, email, adresse" />
        <link rel="canonical" href="https://metrotech-ci.com/contact" />
      </Helmet>
