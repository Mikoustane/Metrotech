...
import { Plus, FileText, Building2, FlaskRound, Factory, Droplet, Thermometer, Guitar as Hospital, ArrowRight } from 'lucide-react';
    ...
    <div className="p-6 space-y-6 no-scrollbar">
      ...
      >
        ...
        <p className="text-gray-400">
          Créez et gérez vos formulaires par service - {drafts.length} formulaire(s) en cours
        </p>
      </motion.div>
      ...
      >
        ...
        <ul className="text-gray-300 space-y-2 text-sm">
          ...
          <li>• Vos brouillons sont automatiquement sauvegardés toutes les 30 secondes</li>
